...
/**
 * Title: Content simple reverse
 * Slug: cvsevrier/content-simple-reverse
 * Categories: cvsevrier/cvsevrier-patterns
 */

?>

<!-- wp:group {"className":"cvs-content-simple cvs-content-simple-reverse","layout":{"type":"constrained"}} -->
<div class="wp-block-group cvs-content-simple cvs-content-simple-reverse"><!-- wp:group {"layout":{"type":"constrained"}} -->
